...
interface IERC20 {
    ...
    * @dev Returns the amount of tokens owned by 'account'.
    ...
    /**
    * @dev Moves `amount` tokens from the caller's account to the `recepient`.
    *
    ...
    *
    * Returns a boolean value indicating wheter the operation succeeded.
    * 
    * IMPORTANT: Beware that changing an allowance with this method brings the risk
    * that someone may use both the old and new allowance by unfortunate
    * transaction ordering. One possible solution to mitigate this race
    * condition is to fiurst reduce the spender's allowance to 0 and set the
    * desired value afterwards:
    * https://github.com/ethereum/EIPs/issues/20#issuecomment-263524729
    * 
    * Emmits an {Approval} event.
     */
...
contract PIAICBCCToken is IERC20{
    //mapping to hold balance against EOA accounts.
    ...
    // tha amount of tokens in existence
    ...
    constructor () public {
        ...
        _totalSupply = 1000000 * 10**decimals;  //exponential formula
    ...
    * - the caller must have a balance of at least `amount`.
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool){
        ...
        require(recipient != address(0), "BCC1: tranfer to the zero address");
        require(_balances[sender] > amount, "BCC1: transfer amount exceeds balnace");

        //decrease the balance of token recipient account
    ...
    * - `sender` must have a balance of at least `amount`.
    ...
    function transferFrom(address tokenOwner, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(_allowance > amount, "BCC1: transfer amount eceeds allowance");
